...
public class AirportTasks {
	...
	/**
	 * emptyInFlight
	 * recursively empties the planes stored within InFlight after a specified box within the array
	 */
	public void emptyInFlight(int count) {	
		if(count == (inFlight.length-1)){
			return;
		}
		else {
			inFlight[count] = null;
			this.emptyInFlight((count + 1));
		}
	}
